...
const OrgHome = () => {
    ...
    return (
        <div className='flex flex-col xl:flex-row justify-center items-center gap-10 pb-4 pt-30 sm:pb-12 md:pb-16 lg:pb-20 bg-linear-to-br from-pink-50 to-gray-200 sm:px-16 lg:px-20 xl:px-36 px-4'>
